      ...
      >
        ...
        {type !== "list" && (
          <>
            ...
            ¿Toda una vida de descuentos? Disfruta con nosotros.
            </h1>
            <p className="headerDesc">
            Obtenga recompensas por sus viajes: desbloquee ahorros instantáneos del 10% o
             más con una cuenta gratuita en HotelesRomo
            </p>
            <button className="headerBtn">Ingresa / Registrate</button>
            <div className="headerSearch">
              <div className="headerSearchItem">
                <FontAwesomeIcon icon={faBed} className="headerIcon" />
                <input
                  type="text"
                  placeholder="Donde puedes buscar ?"
